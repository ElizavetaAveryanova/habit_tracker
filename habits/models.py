...
class Reward(models.Model):
    ...
    created_by = models.ForeignKey('users.User', on_delete=models.CASCADE, **NULLABLE, verbose_name='Автор')
...
class Habit(models.Model):
    ...
    reward_with_action = models.ForeignKey(Reward, on_delete=models.SET_NULL, null=True, blank=True,
                                           verbose_name='Вознаграждение действием')
    reward_with_pleasing_habit = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True,
